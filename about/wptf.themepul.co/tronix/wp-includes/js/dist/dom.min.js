...
!(function () {
  ...
  function m(t) {
    return f(i(t.ownerDocument.body))
      .reverse()
      .find(
  ...
  function h(t) {
    return f(i(t.ownerDocument.body)).find(
  ...
  function w(t) {
    return (
      !!t.activeElement && (y(t.activeElement) || E(t.activeElement) || N(t))
    );
  }
  function T(t) {
    return (
      p(t.ownerDocument.defaultView),
  ...
  function x(t, e, n = !1) {
    if (S(t) && "number" == typeof t.selectionStart)
      return (
  ...
  function F(t) {
    return (
      _()("wp.dom.isNumberInput", { since: "6.1", version: "6.5" }),
  ...
  function J(t) {
    switch (t.nodeType) {
      ...
      case t.ELEMENT_NODE:
        return (
          !t.hasAttributes() &&
          (!t.hasChildNodes() || Array.from(t.childNodes).every(J))
        );
      default:
        return !0;
    }
  ...
  function tt(t) {
    ...
    const {
      ...
      ...Z,
      ins: { children: Z.ins.children },
      del: { children: Z.del.children },
    };
    return a;
  }
  function et(t) {
  ...
  function ot(t, e, n, r) {
    Array.from(t).forEach((t) => {
      ...
      if (!n.hasOwnProperty(o) || (n[o].isMatch && !n[o].isMatch?.(t)))
        ot(t.childNodes, e, n, r),
          r && !et(t) && t.nextElementSibling && z(e.createElement("br"), t),
          k(t);
      else if (
        (function (t) {
        ...
        if (t.hasChildNodes()) {
          ...
          if (c)
            a.length && !t.querySelector(a.join(","))
              ...
              ? (ot(t.childNodes, e, n, r),
                Array.from(t.childNodes).some((t) => !et(t)) && k(t))
              : ot(t.childNodes, e, c, r);
  ...
  function it(t, e, n) {
    ...
    return (
      (r.body.innerHTML = t), ot(r.body.childNodes, r, e, n), r.body.innerHTML
    );
  }
  function ut(t) {
    ...
    return (
      Array.from(t.items).forEach((t) => {
        ...
        n &&
          !e.find(
            ({ name: t, type: e, size: r }) =>
              t === n.name && e === n.type && r === n.size
          ) &&
          e.push(n);
      }),
      e
