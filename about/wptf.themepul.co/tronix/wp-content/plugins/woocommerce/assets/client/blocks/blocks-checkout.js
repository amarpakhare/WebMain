(() => {
                ...
                (lt && lt === t) ||
                  ...
                  (it =
                    "ALLOWED_NAMESPACES" in t
                      ? R({}, t.ALLOWED_NAMESPACES, b)
                      : at),
                  (qe =
                    "ADD_URI_SAFE_ATTR" in t
                      ? R(M(Qe), t.ADD_URI_SAFE_ATTR, ge)
                      : Qe),
                  (Je =
                    "ADD_DATA_URI_TAGS" in t
                      ? R(M(Xe), t.ADD_DATA_URI_TAGS, ge)
                      : Xe),
                  (ze =
                    "FORBID_CONTENTS" in t ? R({}, t.FORBID_CONTENTS, ge) : Ye),
                  ...
                  t.ADD_TAGS &&
                    (xe === Ae && (xe = M(xe)), R(xe, t.ADD_TAGS, ge)),
                  t.ADD_ATTR &&
                    (Te === ke && (Te = M(Te)), R(Te, t.ADD_ATTR, ge)),
                  t.ADD_URI_SAFE_ATTR && R(qe, t.ADD_URI_SAFE_ATTR, ge),
                  t.FORBID_CONTENTS &&
                    (ze === Ye && (ze = M(ze)), R(ze, t.FORBID_CONTENTS, ge)),
                  Ze && (xe["#text"] = !0),
            ...
            var yt = function (e) {
              ...
              St = function (e) {
                ...
                if (
                  ...
                  return yt(e), !0;
                if ("select" === r && A(/<template/i, e.innerHTML))
                  return yt(e), !0;
                if (!xe[r] || Me[r]) {
                  if (!Me[r] && xt(r)) {
                    if (
              ...
              Nt = function (e, t, n) {
                if (Ge && ("id" === t || "name" === t) && (n in a || n in ct))
                  return !1;
                if (Le && !_e[t] && A(Ee, t));
                else if (Oe && A(be, t));
                else if (!Te[t] || _e[t]) {
              ...
              Tt = function e(t) {
                ...
                for (
                  ...
                  wt("uponSanitizeShadowNode", n, null),
                    St(n) || (n.content instanceof s && e(n.content), At(n));
            ...
            return (
              (o.sanitize = function (t) {
                ...
                if (
                  ...
                  (1 ===
                    (a = (r = Ct("\x3c!----\x3e")).ownerDocument.importNode(
                      t,
                      !0
                    )).nodeType &&
                    "BODY" === a.nodeName) ||
                ...
                if (Ue) {
                  if (He)
                    for (d = ue.call(r.ownerDocument); r.firstChild; )
  ...
  (() => {
      ...
      E = (function (e) {
        ...
        return (
          ...
          (t.prototype.correctCaretPosition = function (e, t, n) {
            ...
            for (
              var c = a.substring(t, a.length).indexOf("#"),
                d = t,
                p = t + (-1 === c ? 0 : c);
              d > l && ("#" !== a[d] || !u(e[d]));
              ...
              d -= 1;
            return !u(e[p]) || ("left" === n && t !== l) || t - d < p - t
              ? u(e[d])
                ? d + 1
                : d
              : p;
          ...
          (t.prototype.correctInputValue = function (e, t, n) {
            ...
            if (!i) {
              var k = this.removeFormatting(n),
                ...
                O = R.addNegation,
                L = e < n.indexOf(p) + 1;
              if (k.length < f.length && L && "" === M && !parseFloat(_))
                return O ? "-" : "";
            }
            return n;
          }),
          (t.prototype.updateValue = function (e) {
            ...
            void 0 === a && (a = this.removeFormatting(t)),
              t !== c &&
                ...
                l(this.getValueObject(t, a), { event: i, source: o }));
          }),
    ...
    const w = (e) => ({
      ...
      S = ({
        ...
        const d = s()(
          ...
          p =
            null !== (l = a.decimalScale) && void 0 !== l
              ? l
              : null == n
              ? void 0
              : n.minorUnit,
      ...
      k = ({ currency: e, values: t, className: n }) => {
        ...
        return (0, o.createElement)(x, {
          ...
          value: (0, T.getSetting)("displayCartPricesIncludingTax", !1)
            ? a + s
            : a,
        });
      },
      R = ({
        ...
        if (!(0, T.getSetting)("taxesEnabled", !0) && parseInt(i, 10) <= 0)
          return null;
    ...
    n(878);
    const _ = ({ children: e, slotWrapper: t = !1, className: n }) =>
        l.Children.count(e)
          ? (0, o.createElement)(
              "div",
              {
    ...
    function U({ name: e, children: t, registerFill: n, unregisterFill: r }) {
      ...
      return (
        ...
        (0, l.useLayoutEffect)(() => {
          e !== i.current.name &&
            (r(i.current.name, i.current),
            (i.current.name = e),
            n(e, i.current));
        }, [e]),
        o && o.node
          ? ((0, $.isFunction)(t) && (t = t(o.props.fillProps)),
            (0, l.createPortal)(t, o.node))
          : null
      );
    }
    const H = (e) =>
      (0, l.createElement)(
        ...
        ({ registerFill: t, unregisterFill: n }) =>
          (0, l.createElement)(
            U,
            P({}, e, { registerFill: t, unregisterFill: n })
          )
      );
    class V extends l.Component {
      ...
      render() {
        const {
          ...
          o = (0, $.map)(r(t, this), (e) => {
            const t = (0, $.isFunction)(e.children)
              ? e.children(n)
              : e.children;
    ...
    const G = (e) =>
      (0, l.createElement)(
        ...
        ({ registerSlot: t, unregisterSlot: n, getFills: r }) =>
          (0, l.createElement)(
            V,
            P({}, e, { registerSlot: t, unregisterSlot: n, getFills: r })
          )
      );
    function j() {
      ...
      return (
        ...
        n.ref && n.ref.current
          ? ("function" == typeof t && (t = t(n.fillProps)),
            (0, l.createPortal)(t, n.ref.current))
          : null
      );
    }
    ...
    class X extends l.Component {
      ...
      unregisterFill(e, t) {
        (this.fills[e] = (0, $.without)(this.fills[e], t)),
          this.forceUpdateSlot(e);
      }
      getSlot(e) {
        return this.slots[e];
    ...
    function q(e) {
      return (0, l.createElement)(
        l.Fragment,
        null,
        (0, l.createElement)(H, e),
        (0, l.createElement)(Z, e)
      );
    }
    const Q = (0, l.forwardRef)(({ bubblesVirtually: e, ...t }, n) =>
      e
        ? (0, l.createElement)(K, P({}, t, { ref: n }))
      ...
      return (
        ...
        (0, o.createElement)(
          ...
          (0, o.createElement)(ce, {
            ...
            fillProps: { extensions: t, cart: n, context: r },
          })
        )
      );
    };
      ...
      (
          ...
          (0, l.useLayoutEffect)(() => {
            ...
            const e = () => {
              ...
              let e = (function (e, t, n, r = !1, o, i) {
                ...
                if (!1 !== r) {
                  if (!(r && window.Range && window.Element && window.DOMRect))
                    return;
                  if ("function" == typeof (null == r ? void 0 : r.cloneRange))
                    return Re(
                      (0, Te.getRectangleFromRange)(r),
              ...
              b &&
                (r =
                  null === (l = R.current.closest(".popover-slot")) ||
                  void 0 === l
                    ? void 0
                    : l.parentNode);
              const c = B.height ? B : k.current.getBoundingClientRect(),
                {
                  ...
                  const [c, u = "center", d] = n.split(" "),
                    ...
                    m = (function (e, t, n, r, o, i, a, s, l) {
                      ...
                      "left" === n && (0, A.isRTL)()
                        ? (n = "right")
                        : "right" === n && (0, A.isRTL)() && (n = "left"),
                        "left" === r && (0, A.isRTL)()
                          ? (r = "right")
                          : "right" === r && (0, A.isRTL)() && (r = "left");
                      ...
                      if (!o && !s)
                        if ("center" === n && d.contentWidth === c)
                          ...
                          y = "left";
                        else if ("right" === n && h.contentWidth === c)
                          y = "right";
                        else {
                          y =
                            f.contentWidth > h.contentWidth ? "left" : "right";
                          const e =
                            "left" === y ? f.contentWidth : h.contentWidth;
                          c > window.innerWidth && (v = window.innerWidth),
                            e !== c &&
                              ((y = "center"),
                      ...
                      if (
                        ...
                        (g = Math.min(g, e.right - c)),
                          (0, A.isRTL)() || (g = Math.max(g, 0));
                      }
              ...
              "number" == typeof f &&
                "number" == typeof h &&
                ($e(R.current, "top", f + "px"),
                $e(R.current, "left", h + "px")),
                Be(
                  R.current,
                  "is-without-arrow",
                  o || ("center" === g && "middle" === y)
                ...
                O(
                  ({ left: "right", right: "left" }[g] || "center") +
                    " " +
                    ({ top: "bottom", bottom: "top" }[y] || "middle")
                );
            };
            e();
            ...
            return (
              c &&
                c !== t &&
                (c.defaultView.addEventListener("resize", e),
                c.defaultView.addEventListener("scroll", e, !0)),
              E &&
                ((f = new n.MutationObserver(e)),
              ...
              () => {
                n.clearInterval(r),
                  ...
                  c &&
                    c !== t &&
                    (c.defaultView.removeEventListener("resize", e),
                    c.defaultView.removeEventListener("scroll", e, !0)),
                  f && f.disconnect();
              }
            );
          }, [D, p, m, u, d, a, B, v, E, b]);
        const U = (e, n) => {
          ...
          j =
            ...
            (function (e) {
              if ("loading" === e.type)
                return Ae()("components-animate__loading");
              ...
              return "slide-in" === t
                ? Ae()("components-animate__slide-in", "is-from-" + n)
                : void 0;
        ...
        let Z = (0, l.createElement)(
          ...
          (0, l.createElement)(
            "div",
            { ref: k, className: "components-popover__content" },
            (0, l.createElement)(
              "div",
        ...
        return (
          I.ref && (Z = (0, l.createElement)(q, { name: C }, Z)),
          u || p ? Z : (0, l.createElement)("span", { ref: T }, Z)
        );
      }
    );
    Ue.Slot = (0, l.forwardRef)(function ({ name: e = De }, t) {
      return (0,
      l.createElement)(Q, { bubblesVirtually: !0, name: e, className: "popover-slot", ref: t });
    });
    const He = Ue,
      Ve = function ({ shortcut: e, className: t }) {
        ...
        return (
          (0, $.isString)(e) && (n = e),
          (0, $.isObject)(e) && ((n = e.display), (r = e.ariaLabel)),
          (0, l.createElement)("span", { className: t, "aria-label": r }, n)
        );
      },
      ...
      je = ({ eventHandlers: e, child: t, childrenWithPopover: n }) =>
        (0, l.cloneElement)(
          (0, l.createElement)(
            ...
            (0, l.cloneElement)(Ge, e),
            (0, l.cloneElement)(t, { children: n }),
            ","
          ),
          e
        ),
      Ze = ({ child: e, eventHandlers: t, childrenWithPopover: n }) =>
        (0, l.cloneElement)(e, { ...t, children: n }),
      We = (e, t, n) => {
      ...
      Ke = function ({ children: e, position: t, text: n, shortcut: r }) {
        ...
        if (((0, l.useEffect)(() => h, []), 1 !== l.Children.count(e)))
          return e;
        const g = {
      ...
      Ye = function ({ icon: e = null, size: t = 24, ...n }) {
        if ("string" == typeof e)
          return (0, l.createElement)(ze, P({ icon: e }, n));
        if ((0, l.isValidElement)(e) && ze === e.type)
          return (0, l.cloneElement)(e, { ...n });
        if ("function" == typeof e)
          return e.prototype instanceof l.Component
            ? (0, l.createElement)(e, { size: t, ...n })
            : e({ size: t, ...n });
      ...
      qe = (0, l.forwardRef)(function (e, t) {
        const {
          ...
          T =
            "a" === A
              ? { href: n, target: r }
              : { type: "button", disabled: x, "aria-pressed": i };
        if (u && b) {
          T["aria-disabled"] = !0;
          for (const e of Xe)
            S[e] = (e) => {
        ...
        const k =
          ...
          _ = (0, l.createElement)(
            ...
            d &&
              "right" === p &&
              (0, l.createElement)(Ye, { icon: d, size: m }),
            v
          );
        return k
          ? (0, l.createElement)(
              ...
              (0, l.createElement)(
                Ke,
                { text: w || y, shortcut: g, position: h },
                _
              ),
              w &&
                (0, l.createElement)(
    ...
    const Qe = () =>
      ...
      nt = ({
        ...
        return !a && c
          ? ((i = n || "span"),
            (r = { ...r, className: s()(r.className, "screen-reader-text") }),
            (0, o.createElement)(i, { ...r }, t))
          : ((i = n || l.Fragment),
            a && c && e !== t
              ? (0, o.createElement)(
                  i,
    ...
    const ht = (0, o.createElement)(
      ...
      wt = ({ className: e, children: t, status: n, ...r }) =>
        (0, o.createElement)(
          bt,
          { className: s()("wc-block-store-notice", e), status: n, ...r },
          t
        ),
      St = ({ className: e, notices: t }) => {
        ...
        (0, l.useEffect)(() => {
          ...
          (t &&
            ...
            (i.filter((e) => !a || !a.includes(e)).length &&
              null != e &&
              e.scrollIntoView &&
          ...
          u.map((e) =>
            (0, o.createElement)(
              ...
              (0, o.createElement)(
                l.RawHTML,
                null,
                dt((0, mt.decodeEntities)(e.content))
              )
            )
          ),
          Object.entries(d).map(([e, t]) => {
            ...
            return 1 === n.length
              ? (0, o.createElement)(
                  wt,
                  { ...i },
                  (0, o.createElement)(l.RawHTML, null, t[0].content)
                )
              : (0, o.createElement)(
                  wt,
                  {
        ...
        return (
              ...
              children: t.firstRender
                ? ((n = e),
                  ...
                  kt(n.children, function (e) {
                    return (0,
                    o.cloneElement)(e, { onExited: r.bind(null, e), in: !0, appear: Rt(e, "appear", n), enter: Rt(e, "enter", n), exit: Rt(e, "exit", n) });
                  }))
                : Mt(e, i, a),
              firstRender: !1,
            };
          ...
          (n.render = function () {
            ...
            return (
              ...
              delete r.exit,
              null === t
                ? i().createElement(Tt.Provider, { value: o }, a)
                : i().createElement(
                    Tt.Provider,
                    { value: o },
      ...
      Gt = (function (e) {
        function t(t, n) {
          ...
          return (
            ...
            t.in
              ? i
                ? ((o = Bt), (r.appearStatus = Ut))
                : (o = Ht)
              : (o = t.unmountOnExit || t.mountOnEnter ? $t : Bt),
            (r.state = { status: o }),
            (r.nextCallback = null),
            r
          );
          ...
          t.split(" ").forEach(function (t) {
            return (
              ...
              void ((n = e).classList
                ...
                ? (n.className = It(n.className, r))
                : n.setAttribute(
                    "class",
                    It((n.className && n.className.baseVal) || "", r)
                  ))
            );
            var n, r;
          })
    ...
    const Yt = ({
        ...
        return (0, o.createElement)(
          ...
          i
            ? e.map((e) => {
                ...
                return (0, o.createElement)(
                  Yt,
                  { ...n, onRemove: a(e), listRef: r, key: e.id },
                  e.content
                );
              })
            : (0, o.createElement)(
      ...
      Qt = ({
        ...
        const { registerContainer: r, unregisterContainer: i } = (0,
          ot.useDispatch)(it.STORE_NOTICES_STORE_KEY),
          { suppressNotices: a, registeredContainers: s } = (0, ot.useSelect)(
            (e) => ({
              suppressNotices: e(
                it.PAYMENT_STORE_KEY
              ).isExpressPaymentMethodActive(),
              registeredContainers: e(
                it.STORE_NOTICES_STORE_KEY
              ).getRegisteredContainers(),
            })
          ),
          c = (0, l.useMemo)(() => (Array.isArray(t) ? t : [t]), [t]),
          u = Object.values(at).filter(
            (e) => c.some((t) => e.includes(t + "/")) && !s.includes(e)
          ),
          d = (0, ot.useSelect)((e) => {
            const { getNotices: t } = e("core/notices");
            return [
              ...u.flatMap((e) => qt(t(e), e)),
              ...c.flatMap((e) => qt(t(e).concat(n), e)),
            ].filter(Boolean);
          });
        return (
          (0, l.useEffect)(
    ...
    const an = ({
        ...
        const { validationError: r, validationErrorId: i } = (0, ot.useSelect)(
          (e) => {
      ...
      cn = (e, t) => {
        ...
        const s = (0, A.sprintf)(
          ...
          (0, A.__)("Please enter a valid %s", "woocommerce"),
          e.toLowerCase()
        );
    ...
    const dn = new Map([
      ...
      fn =
        ...
        (e) => {
          const { applyExtensionCartUpdate: t } = (0, ot.dispatch)(
            "wc/store/cart"
          );
          return t(e);
        }),
      hn = (0, l.forwardRef)(
        (
          ...
          const [E, b] = (0, l.useState)(!0),
            ...
            } = (0, ot.useDispatch)(it.VALIDATION_STORE_KEY),
            M = (0, l.useRef)(m);
          (0, l.useEffect)(() => {
            M.current = m;
          }, [m]);
          const { validationError: _, validationErrorId: O } = (0,
            ot.useSelect)((e) => {
          ...
          (0, l.useImperativeHandle)(
            ...
            (0, l.useEffect)(() => {
              ...
              E &&
                (b(!1),
                a && (null === (e = S.current) || void 0 === e || e.focus()),
                (!g && a) || L(!0));
            }, [g, a, E, b, L]),
            (0, l.useEffect)(
              () => () => {
            ...
            "" !== d && nn(_) && (_.message = d);
          const I =
              (null == _ ? void 0 : _.message) && !(null != _ && _.hidden),
            D = u && I && O ? O : r;
          return (0, o.createElement)(on, {
            ...
            type: n,
            feedback: u
              ? (0, o.createElement)(an, { errorMessage: d, propertyName: A })
              : null,
            ref: S,
            onChange: (e) => {
              k(A), L(!0);
    ...
    const kn = {},
      ...
      Mn = (e) =>
        Rn(e)
          ? Object.values(kn).filter(({ metadata: t }) =>
      ...
      Ln = (e) => {
        ...
        ((e, t, n) => {
          ...
          if (r !== n)
            throw new Error(
              `Incorrect value for the ${t} argument when registering a block component. It was a ${r}, but must be a ${n}.`
            );
        })(e, "metadata", "object"),
          ((e) => {
            if (
              (((e, t, n) => {
                ...
                if (r !== n)
                  throw new Error(
                    `Incorrect value for the blockName argument when registering a checkout block. It was a ${r}, but must be a ${n}.`
                  );
              })(0, e, "string"),
              !e)
            )
