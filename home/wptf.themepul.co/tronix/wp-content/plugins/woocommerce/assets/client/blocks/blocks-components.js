                ...
                (lt && lt === t) ||
                  ...
                  (at =
                    "ALLOWED_NAMESPACES" in t
                      ? _({}, t.ALLOWED_NAMESPACES, b)
                      : it),
                  (qe =
                    "ADD_URI_SAFE_ATTR" in t
                      ? _(R(Qe), t.ADD_URI_SAFE_ATTR, ge)
                      : Qe),
                  (Je =
                    "ADD_DATA_URI_TAGS" in t
                      ? _(R(Xe), t.ADD_DATA_URI_TAGS, ge)
                      : Xe),
                  (ze =
                    "FORBID_CONTENTS" in t ? _({}, t.FORBID_CONTENTS, ge) : Ye),
                  ...
                  t.CUSTOM_ELEMENT_HANDLING &&
                    ...
                    (_e.tagNameCheck = t.CUSTOM_ELEMENT_HANDLING.tagNameCheck),
                  t.CUSTOM_ELEMENT_HANDLING &&
                  ...
                  t.ADD_TAGS &&
                    (xe === Ae && (xe = R(xe)), _(xe, t.ADD_TAGS, ge)),
                  t.ADD_ATTR &&
                    (Te === ke && (Te = R(Te)), _(Te, t.ADD_ATTR, ge)),
                  t.ADD_URI_SAFE_ATTR && _(qe, t.ADD_URI_SAFE_ATTR, ge),
                  t.FORBID_CONTENTS &&
                    (ze === Ye && (ze = R(ze)), _(ze, t.FORBID_CONTENTS, ge)),
                  Ke && (xe["#text"] = !0),
            ...
            var vt = function (e) {
              ...
              Nt = function (e) {
                ...
                if (
                  ...
                  return vt(e), !0;
                if ("select" === o && A(/<template/i, e.innerHTML))
                  return vt(e), !0;
                if (!xe[o] || Re[o]) {
                  if (!Re[o] && xt(o)) {
                    if (
                ...
                return e instanceof d &&
                  ...
                  ? (Ie &&
                      ...
                      (t = N(t, Ce, " ")),
                      e.textContent !== t &&
                        (C(r.removed, { element: e.cloneNode() }),
                        (e.textContent = t))),
              ...
              St = function (e, t, n) {
                if (Ge && ("id" === t || "name" === t) && (n in i || n in ct))
                  return !1;
                if (Oe && !Me[t] && A(Ee, t));
                else if (Le && A(be, t));
                else if (!Te[t] || Me[t]) {
              ...
              Tt = function e(t) {
                ...
                for (
                  ...
                  wt("uponSanitizeShadowNode", n, null),
                    Nt(n) || (n.content instanceof s && e(n.content), At(n));
            ...
            return (
              (r.sanitize = function (t) {
                ...
                if (
                  ...
                  (1 ===
                    (i = (o = Ct("\x3c!----\x3e")).ownerDocument.importNode(
                      t,
                      !0
                    )).nodeType &&
                    "BODY" === i.nodeName) ||
                  ...
                  if (!He && !Ie && !Pe && -1 === t.indexOf("<"))
                    return ae && Ue ? ae.createHTML(t) : t;
                  if (!(o = Ct(t))) return He ? null : Ue ? ie : "";
                }
                o && Be && vt(o.firstChild);
                for (var f = Et(je ? t : o); (l = f.nextNode()); )
                  (3 === l.nodeType && l === u) ||
                    Nt(l) ||
                    (l.content instanceof s && Tt(l.content), At(l), (u = l));
                if (((u = null), je)) return t;
                if (He) {
                  if (Ve)
                    for (d = ue.call(o.ownerDocument); o.firstChild; )
                      d.appendChild(o.firstChild);
                  else d = o;
                  return (
                    (Te.shadowroot || Te.shadowrootmod) &&
                      (d = pe.call(a, d, !0)),
                    d
                  );
                }
                ...
                return (
                  Pe &&
                    ...
                    A(X, o.ownerDocument.doctype.name) &&
                    (h =
  ...
  (() => {
    ...
    function S({ name: e, children: t, registerFill: n, unregisterFill: o }) {
      ...
      return (
        ...
        (0, a.useLayoutEffect)(() => {
          e !== i.current.name &&
            (o(i.current.name, i.current),
            (i.current.name = e),
            n(e, i.current));
        }, [e]),
        r && r.node
          ? ((0, l.isFunction)(t) && (t = t(r.props.fillProps)),
            (0, a.createPortal)(t, r.node))
          : null
      );
    }
    const x = (e) =>
      (0, a.createElement)(
        ...
        ({ registerFill: t, unregisterFill: n }) =>
          (0, a.createElement)(
            S,
            r({}, e, { registerFill: t, unregisterFill: n })
          )
      );
      ...
      render() {
        const {
          ...
          r = (0, l.map)(o(t, this), (e) => {
            const t = (0, l.isFunction)(e.children)
              ? e.children(n)
              : e.children;
    ...
    const T = (e) =>
      (0, a.createElement)(
        ...
        ({ registerSlot: t, unregisterSlot: n, getFills: o }) =>
          (0, a.createElement)(
            A,
            r({}, e, { registerSlot: t, unregisterSlot: n, getFills: o })
          )
      );
    function k() {
      ...
      return (
        ...
        n.ref && n.ref.current
          ? ("function" == typeof t && (t = t(n.fillProps)),
            (0, a.createPortal)(t, n.ref.current))
          : null
      );
    }
    ...
    function M(e) {
      return (0, a.createElement)(
        a.Fragment,
        null,
        (0, a.createElement)(x, e),
        (0, a.createElement)(_, e)
      );
    }
    const L = (0, a.forwardRef)(({ bubblesVirtually: e, ...t }, n) =>
      e
        ? (0, a.createElement)(R, r({}, t, { ref: n }))
      ...
      (
          ...
          (0, a.useLayoutEffect)(() => {
            ...
            const e = () => {
              ...
              let e = (function (e, t, n, o = !1, r, a) {
                ...
                if (!1 !== o) {
                  if (!(o && window.Range && window.Element && window.DOMRect))
                    return;
                  if ("function" == typeof (null == o ? void 0 : o.cloneRange))
                    return g(
                      (0, p.getRectangleFromRange)(o),
                      o.endContainer.ownerDocument,
                      a
                    );
                  if (
                    "function" ==
                    typeof (null == o ? void 0 : o.getBoundingClientRect)
                  ) {
              ...
              L &&
                (o =
                  null === (a = K.current.closest(".popover-slot")) ||
                  void 0 === a
                    ? void 0
                    : a.parentNode);
                  ...
                  const [c, u = "center", d] = n.split(" "),
                    p = (function (e, t, n, o, r, a, i, s) {
                      ...
                      if (!r && !s)
                        if ("middle" === n && u.contentHeight === l)
                          ...
                          f = "top";
                        else if ("bottom" === n && p.contentHeight === l)
                          f = "bottom";
                        else {
                          f =
                            d.contentHeight > p.contentHeight
                              ? "top"
                              : "bottom";
                          const e =
                            "top" === f ? d.contentHeight : p.contentHeight;
                          h = e !== l ? e : null;
                        }
                      return (
                        (m =
                          "middle" === f
                            ...
                            ? d.popoverTop
                            : p.popoverTop),
                        { yAxis: f, popoverTop: m, contentHeight: h }
                      );
                    })(e, t, c, d, o, 0, a, s),
                    m = (function (e, t, n, o, r, a, i, s, l) {
                      ...
                      "left" === n && (0, h.isRTL)()
                        ...
                        "left" === o && (0, h.isRTL)()
                          ? (o = "right")
                          : "right" === o && (0, h.isRTL)() && (o = "left");
                      const u = Math.round(e.left + e.width / 2),
                        d = {
                          popoverLeft: u,
                          contentWidth:
                            (u - c / 2 > 0 ? c / 2 : u) +
                            (u + c / 2 > window.innerWidth
                              ? window.innerWidth - u
                              : c / 2),
                        };
                      let p = e.left;
                      ...
                      let v,
                        ...
                        C = null;
                      if (!r && !s)
                        if ("center" === n && d.contentWidth === c)
                          y = "center";
                        else if ("left" === n && f.contentWidth === c)
                          y = "left";
                        else if ("right" === n && g.contentWidth === c)
                          y = "right";
                        else {
                          y =
                            f.contentWidth > g.contentWidth ? "left" : "right";
                          const e =
                            "left" === y ? f.contentWidth : g.contentWidth;
                          c > window.innerWidth && (C = window.innerWidth),
                            e !== c &&
                              ((y = "center"),
                              (d.popoverLeft = window.innerWidth / 2));
                        }
                      if (
                        ((v =
                          "center" === y
                        ...
                        (v = Math.min(v, e.right - c)),
                          (0, h.isRTL)() || (v = Math.max(v, 0));
                      }
              ...
              "number" == typeof u &&
                "number" == typeof d &&
                (P(K.current, "top", u + "px"), P(K.current, "left", d + "px")),
                F(
                  K.current,
                  "is-without-arrow",
                  i || ("center" === m && "middle" === f)
                ...
                z(
                  ({ left: "right", right: "left" }[m] || "center") +
                    " " +
                    ({ top: "bottom", bottom: "top" }[f] || "middle")
                );
            };
            e();
            ...
            return (
              s &&
                s !== t &&
                (s.defaultView.addEventListener("resize", e),
                s.defaultView.addEventListener("scroll", e, !0)),
              R &&
                ((u = new n.MutationObserver(e)),
                u.observe(R, { attributes: !0 })),
              () => {
                n.clearInterval(o),
                  ...
                  s &&
                    s !== t &&
                    (s.defaultView.removeEventListener("resize", e),
                    s.defaultView.removeEventListener("scroll", e, !0)),
                  u && u.disconnect();
              }
            );
          }, [J, b, N, y, C, c, Q, k, R, L]);
        const ee = (e, n) => {
          ...
          re =
            ...
            (function (e) {
              if ("loading" === e.type)
                return s()("components-animate__loading");
              ...
              return "slide-in" === t
                ? s()("components-animate__slide-in", "is-from-" + n)
                : void 0;
        ...
        return (
          Y.ref && (ae = (0, a.createElement)(M, { name: _ }, ae)),
          y || b ? ae : (0, a.createElement)("span", { ref: G }, ae)
        );
      }
    );
    B.Slot = (0, a.forwardRef)(function ({ name: e = D }, t) {
      return (0,
      a.createElement)(L, { bubblesVirtually: !0, name: e, className: "popover-slot", ref: t });
    });
    const H = B,
      V = function ({ shortcut: e, className: t }) {
        ...
        return (
          (0, l.isString)(e) && (n = e),
          (0, l.isObject)(e) && ((n = e.display), (o = e.ariaLabel)),
          (0, a.createElement)("span", { className: t, "aria-label": o }, n)
        );
      },
      ...
      G = ({ eventHandlers: e, child: t, childrenWithPopover: n }) =>
        (0, a.cloneElement)(
          (0, a.createElement)(
            ...
            (0, a.cloneElement)(U, e),
            (0, a.cloneElement)(t, { children: n }),
            ","
          ),
          e
        ),
      Z = ({ child: e, eventHandlers: t, childrenWithPopover: n }) =>
        (0, a.cloneElement)(e, { ...t, children: n }),
      K = (e, t, n) => {
      ...
      j = function ({ children: e, position: t, text: n, shortcut: o }) {
        ...
        if (((0, a.useEffect)(() => v, []), 1 !== a.Children.count(e)))
          return e;
        const y = {
      ...
      z = function ({ icon: e = null, size: t = 24, ...n }) {
        if ("string" == typeof e)
          return (0, a.createElement)(W, r({ icon: e }, n));
        if ((0, a.isValidElement)(e) && W === e.type)
          return (0, a.cloneElement)(e, { ...n });
        if ("function" == typeof e)
          return e.prototype instanceof a.Component
            ? (0, a.createElement)(e, { size: t, ...n })
            : e({ size: t, ...n });
      ...
      X = (0, a.forwardRef)(function (e, t) {
        const {
            ...
            return (
              ...
              e &&
                (u()("Button isDefault prop", {
                  since: "5.4",
                  alternative: 'variant="secondary"',
                }),
                (null !== (p = s) && void 0 !== p) || (s = "secondary")),
          ...
          M =
            "a" === R
              ? { href: n, target: o }
              : { type: "button", disabled: _, "aria-pressed": c };
        if (f && x) {
          M["aria-disabled"] = !0;
          for (const e of J)
            T[e] = (e) => {
        ...
        const L =
            ...
            ((y && b) ||
              E ||
              (!!b && (!w || ((0, l.isArray)(w) && !w.length)) && !1 !== y)),
        ...
        return L
          ? (0, a.createElement)(
              ...
              (0, a.createElement)(
                j,
                { text: A || b, shortcut: E, position: C },
                $
              ),
              A &&
                (0, a.createElement)(
            ...
            (0, e.createElement)(
              ...
              (0, e.createElement)(
                ...
                (0, h.sprintf)(
                  ...
                  (0, h._n)("Show %s more", "Show %s more", t, "woocommerce"),
                  t
                )
              )
            )
    ...
    const ie = ({
        ...
        return (0, e.createElement)(
          ...
          (0, e.createElement)(
            "span",
            { "aria-hidden": u, className: "wc-block-components-chip__text" },
            t
          ),
          u &&
            (0, e.createElement)(
      ...
      ce = ({
        ...
        if (!t) {
          ...
          t =
            "string" !=
            typeof e /* translators: Remove chip. */ /* translators: Remove chip. */
    ...
    const ue = ({ children: t, className: n = "", headingLevel: o, ...r }) => {
      ...
      pe = ({
        ...
        return (0, e.createElement)(
          ...
          !!o &&
            (0, e.createElement)(de, { title: o, stepHeadingContent: c() }),
          (0, e.createElement)(
            "div",
      ...
      Se = (function (e) {
        ...
        return (
            ...
            return (
              -1 !== a &&
                (e =
                  ...
                  "." +
                  e
                    .substring(a + 1, e.length)
                    .replace(new RegExp(ge(n), "g"), "")),
              r && (e = "-" + e),
              e
            );
          }),
          ...
          (n.prototype.getMaskAtIndex = function (e) {
            ...
            return (
              void 0 === t && (t = " "), "string" == typeof t ? t : t[e] || " "
            );
          }),
          ...
          (n.prototype.correctCaretPosition = function (e, t, n) {
            ...
            for (
              var c = i.substring(t, i.length).indexOf("#"),
                u = t,
                d = t + (-1 === c ? 0 : c);
              u > l && ("#" !== i[u] || !fe(e[u]));
              ...
              u -= 1;
            return !fe(e[d]) || ("left" === n && t !== l) || t - u < d - t
              ? fe(e[u])
                ? u + 1
                : u
              : d;
          ...
          (n.prototype.getCaretPosition = function (e, t, n) {
            ...
            for (o = 0, r = 0; r < n; r++) {
              ...
              if (
                (u.match(s) || u === d) &&
                ("0" !== u || !d.match(s) || "0" === d || l.length === c.length)
              ) {
            ...
            return (
              "string" != typeof a || i || (o = t.length),
              this.correctCaretPosition(t, o)
            );
          }),
          (n.prototype.removePrefixAndSuffix = function (e) {
            ...
            if (!n && e) {
              ...
              var i = (e =
                o && 0 === e.indexOf(o)
                  ? e.substring(o.length, e.length)
                  : e).lastIndexOf(r);
              (e =
                r && -1 !== i && i === e.length - r.length
                  ? e.substring(0, i)
                  : e),
                a && (e = "-" + e);
            }
          ...
          (n.prototype.formatWithPattern = function (e) {
            for (
              ...
              "#" === t[r] &&
                ((o[r] = e[n] || this.getMaskAtIndex(n)), (n += 1));
            return o.join("");
          }),
              ...
              c &&
                (m = (function (e, t, n) {
                  ...
                  return (
                    (r = -1 === r ? e.length : r),
                    e.substring(0, r) +
                      e.substring(r, e.length).replace(o, "$1" + t)
                  );
                })(m, c, s)),
              r && (m = r + m),
              a && (f += a),
          ...
          (n.prototype.correctInputValue = function (e, t, n) {
            var o = this,
              ...
              v = (function (e, t) {
                for (
                  var n = 0, o = 0, r = e.length, a = t.length;
                  e[n] === t[n] && n < r;
            ...
            if (
              ...
              [].concat(S).forEach(function (e, n) {
                o.isCharacterAFormat(n + y, t)
                  ? (x[n] = e)
                  : n > N.length - 1 && A.push(e);
              }),
            ...
            if (!a) {
              var T = this.removeFormatting(n),
                ...
                M = k.addNegation,
                L = e < n.indexOf(p) + 1;
              if (T.length < m.length && L && "" === _ && !parseFloat(R))
                return M ? "-" : "";
            }
            return n;
          }),
          (n.prototype.updateValue = function (e) {
            ...
            void 0 === i && (i = this.removeFormatting(t)),
              t !== c &&
                ...
                l(this.getValueObject(t, i), { event: a, source: r }));
          }),
          ...
          (n.prototype.onKeyDown = function (e) {
            ...
            if (
              ...
              (y !== t || t < C || t > E) &&
                (e.preventDefault(), this.setPatchedCaretPosition(n, y, i)),
                e.isUnitTestRun && this.setPatchedCaretPosition(n, y, i),
                m(e);
            } else m(e);
          }),
          ...
          (n.prototype.onFocus = function (e) {
            ...
            e.persist(),
              ...
              (this.focusTimeout = setTimeout(function () {
                ...
                i === o ||
                  (0 === o && r === a.length) ||
                  t.setPatchedCaretPosition(n, i, a),
                  t.props.onFocus(e);
              }, 0));
          }),
    ...
    const Ae = (e) => ({
      ...
      Te = ({
        ...
        const u = Q()(
          ...
          d =
            null !== (s = i.decimalScale) && void 0 !== s
              ? s
              : null == o
              ? void 0
              : o.minorUnit,
      ...
      ke = ({
        ...
        return !s && l
          ? ((i = o || "span"),
            (r = { ...r, className: Q()(r.className, "screen-reader-text") }),
            (0, e.createElement)(i, { ...r }, n))
          : ((i = o || a.Fragment),
            s && l && t !== n
              ? (0, e.createElement)(
                  i,
                  { ...r },
                  (0, e.createElement)("span", { "aria-hidden": "true" }, t),
                  (0, e.createElement)(
                    "span",
                    { className: "screen-reader-text" },
                    n
    ...
    const Be = (0, e.createElement)(
      ...
      je = ({ className: t, children: n, status: o, ...r }) =>
        (0, e.createElement)(
          Ke,
          { className: Q()("wc-block-store-notice", t), status: o, ...r },
          n
        ),
      We = window.wp.data,
      ...
      ot = ({ className: t, notices: n }) => {
        ...
        (0, a.useEffect)(() => {
          ...
          (t &&
            ...
            (i.filter((e) => !s || !s.includes(e)).length &&
              null != e &&
              e.scrollIntoView &&
        ...
        return (0, e.createElement)(
          ...
          c.map((t) =>
            (0, e.createElement)(
              je,
              { key: t.id + "-" + t.context, ...t },
              (0, e.createElement)(
                a.RawHTML,
                null,
                et((0, nt.decodeEntities)(t.content))
              )
            )
          ),
          Object.entries(u).map(([t, n]) => {
            ...
            const o = n
                .filter(
                  (e, t, n) => n.findIndex((t) => t.content === e.content) === t
                )
                .map((e) => ({
                  ...e,
            ...
            return 1 === o.length
              ? (0, e.createElement)(
                  je,
                  { ...i },
                  (0, e.createElement)(a.RawHTML, null, n[0].content)
                )
              : (0, e.createElement)(
                  je,
                  {
        ...
        return (
              ...
              children: n.firstRender
                ? ((o = t),
                  ...
                  lt(o.children, function (t) {
                    return (0,
                    e.cloneElement)(t, { onExited: r.bind(null, t), in: !0, appear: ct(t, "appear", o), enter: ct(t, "enter", o), exit: ct(t, "exit", o) });
                  }))
                : ut(t, a, i),
              firstRender: !1,
            };
          ...
          (a.render = function () {
            ...
            return (
              ...
              delete r.exit,
              null === n
                ? t().createElement(st.Provider, { value: a }, i)
                : t().createElement(
                    st.Provider,
                    { value: a },
      ...
      Nt = (function (e) {
        function n(t, n) {
          ...
          return (
            ...
            t.in
              ? a
                ? ((r = Ct), (o.appearStatus = Et))
                : (r = bt)
              : (r = t.unmountOnExit || t.mountOnEnter ? yt : Ct),
            (o.state = { status: r }),
            (o.nextCallback = null),
            o
          );
        ...
        return (
          ...
          (o.render = function () {
            ...
            return t().createElement(
              ...
              "function" == typeof o
                ? o(e, r)
                : t().cloneElement(t().Children.only(o), r)
            );
          }),
          n
        );
          ...
          t.split(" ").forEach(function (t) {
            return (
              ...
              void ((n = e).classList
                ...
                ? (n.className = ft(n.className, o))
                : n.setAttribute(
                    "class",
                    ft((n.className && n.className.baseVal) || "", o)
                  ))
            );
            var n, o;
          })
    ...
    const _t = ({
        ...
        return (0, e.createElement)(
          ...
          i
            ? t.map((t) => {
                ...
                return (0, e.createElement)(
                  _t,
                  { ...o, onRemove: s(t), listRef: r, key: t.id },
                  t.content
                );
              })
            : (0, e.createElement)(
      ...
      Ot = ({
        ...
        const { registerContainer: r, unregisterContainer: i } = (0,
          We.useDispatch)(ze.STORE_NOTICES_STORE_KEY),
          { suppressNotices: s, registeredContainers: l } = (0, We.useSelect)(
            (e) => ({
              suppressNotices: e(
                ze.PAYMENT_STORE_KEY
              ).isExpressPaymentMethodActive(),
              registeredContainers: e(
                ze.STORE_NOTICES_STORE_KEY
              ).getRegisteredContainers(),
            })
          ),
          c = (0, a.useMemo)(() => (Array.isArray(n) ? n : [n]), [n]),
          u = Object.values(Ye).filter(
            (e) => c.some((t) => e.includes(t + "/")) && !l.includes(e)
          ),
          d = (0, We.useSelect)((e) => {
            const { getNotices: t } = e("core/notices");
            return [
              ...u.flatMap((e) => Lt(t(e), e)),
              ...c.flatMap((e) => Lt(t(e).concat(o), e)),
            ].filter(Boolean);
          });
        return (
          (0, a.useEffect)(
    ...
    const It = ({
        ...
        const { validationError: r, validationErrorId: a } = (0, We.useSelect)(
          (e) => {
      ...
      Ft = (e, t) => {
        ...
        const s = (0, h.sprintf)(
          ...
          (0, h.__)("Please enter a valid %s", "woocommerce"),
          e.toLowerCase()
        );
        ...
        (0, a.forwardRef)(
          (
            ...
            const [E, b] = (0, a.useState)(!0),
              ...
              } = (0, We.useDispatch)(ze.VALIDATION_STORE_KEY),
              R = (0, a.useRef)(m);
            (0, a.useEffect)(() => {
              R.current = m;
            }, [m]);
            const { validationError: M, validationErrorId: L } = (0,
              We.useSelect)((e) => {
                const t = e(ze.VALIDATION_STORE_KEY);
                return {
            ...
            (0, a.useImperativeHandle)(
              ...
              "" !== u &&
                ...
                (M.message = u);
            const $ =
                (null == M ? void 0 : M.message) && !(null != M && M.hidden),
              I = c && $ && L ? L : r;
            return (0, e.createElement)($t, {
              ...
              type: o,
              feedback: c
                ? (0, e.createElement)(It, { errorMessage: u, propertyName: A })
                : null,
              ref: N,
              onChange: (e) => {
                k(A), O(!0);
    ...
    const Gt = ({ value: t, currency: n }) =>
      ...
      jt = ({ currency: t, values: n, className: o }) => {
        ...
        return (0, e.createElement)(Zt, {
          ...
          value: (0, Kt.getSetting)("displayCartPricesIncludingTax", !1)
            ? i + s
            : i,
        });
      },
      Wt = ({
        ...
        if (!(0, Kt.getSetting)("taxesEnabled", !0) && parseInt(a, 10) <= 0)
          return null;
    ...
    n(878);
    const Yt = ({ children: t, slotWrapper: n = !1, className: o }) =>
      a.Children.count(t)
        ? (0, e.createElement)(
            "div",
            {
