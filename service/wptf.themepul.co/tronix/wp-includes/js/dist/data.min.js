  ...
  var e = {
      ...
      2167: function (e) {
        ...
        function n(e, t) {
          ...
          for (
            var s = Object.keys(t).sort(), i = Array.isArray(t) ? n : o, u = 0;
            u < s.length;
            u++
          ) {
            var c = s[u];
  ...
  !(function () {
    ...
    const L = {
      ...
      x = {
        [j]: T(
          (e) =>
            ({ storeKey: t, selectorName: r, args: n }) =>
              e.select(t)[r](...n)
        ),
        [N]: T((e) => ({ storeKey: t, selectorName: r, args: n }) => {
          const o = e.select(t)[r].hasResolver ? "resolveSelect" : "select";
          return e[o](t)[r](...n);
        }),
        [A]: T(
          (e) =>
            ({ storeKey: t, actionName: r, args: n }) =>
              e.dispatch(t)[r](...n)
        ),
      };
    var M = window.wp.privateApis;
    const { lock: F, unlock: U } = (0,
    M.__dangerousOptInToUnstableAPIsOnlyForCoreModules)(
      ...
      return (
        Object.entries(o).forEach(([r, o]) => {
          ...
          s &&
            s.shouldInvalidate &&
            o.forEach((o, i) => {
              ("finished" !== o?.status && "error" !== o?.status) ||
                !s.shouldInvalidate(n, ...i) ||
                e.dispatch(C).invalidateResolution(t, r, i);
            });
        }),
        r(n)
      );
    ...
    (e) =>
      ...
      switch (t.type) {
        case "START_RESOLUTION": {
          const r = new (w())(e);
          return r.set(G(t.args), { status: "resolving" }), r;
        }
        case "FINISH_RESOLUTION": {
          const r = new (w())(e);
          return r.set(G(t.args), { status: "finished" }), r;
        }
        case "FAIL_RESOLUTION": {
          const r = new (w())(e);
          return r.set(G(t.args), { status: "error", error: t.error }), r;
        }
        case "START_RESOLUTIONS": {
          const r = new (w())(e);
          for (const e of t.args) r.set(G(e), { status: "resolving" });
          return r;
        }
        case "FINISH_RESOLUTIONS": {
          const r = new (w())(e);
          for (const e of t.args) r.set(G(e), { status: "finished" });
          return r;
        }
    ...
    function re(e) {
      return Object.values(e).some((e) =>
        Array.from(e._map.values()).some((e) => "resolving" === e[1]?.status)
      );
    }
        ...
        for (
          t = (function (e) {
            ...
            t.isUniqueByDependants ||
              (t.lastDependants && !X(u, t.lastDependants, 0) && t.clear(),
              (t.lastDependants = u)),
            o = t.head;
          o;
        ...
        return (
          Object.values(e).forEach((e) =>
            Array.from(e._map.values()).forEach((e) => {
              var r;
              const n =
                null !== (r = e[1]?.status) && void 0 !== r ? r : "error";
              t[n] || (t[n] = 0), t[n]++;
            })
          ),
          t
    ...
    const ge = (e) => {
      ...
      ye = (e, t) =>
        Object.fromEntries(
          Object.entries(null != e ? e : {}).map(([e, r]) => [e, t(r, e)])
        ),
        ...
        c = {
          ...
          instantiate: (c) => {
                ...
                "undefined" != typeof window &&
                  ...
                  c.push(
                    window.__REDUX_DEVTOOLS_EXTENSION__({
                      name: e,
                      instanceId: e,
                      serialize: { replacer: de },
                    })
                  );
                const { reducer: a, initialState: l } = t,
                  f = i()({ metadata: W, root: a });
                return h(f, { root: l }, (0, _.compose)(c));
              })(r, n, c, {
                registry: c,
                get dispatch() {
                  return b;
            ...
            const y = { ...ye(t, g), ...ye(n.actions, g) },
              ...
              b = new Proxy(v, { apply: (e, t, [r]) => f.dispatch(r) });
            F(y, v);
            const S = n.resolvers
              ? (function (e) {
                  return ye(e, (e) => (e.fulfill ? e : { ...e, fulfill: e }));
                })(n.resolvers)
              : {};
            function m(e, t) {
                  ...
                  r.hasResolver
                    ? (...o) => {
                        ...
                        if (e.hasFinishedResolution(n, o)) {
                          if (e.hasResolutionFailed(n, o))
                            throw e.getResolutionError(n, o);
                          return s;
                        }
                        throw new Promise((r) => {
                          const s = t.subscribe(() => {
    ...
    function Oe(e = {}, t = null) {
      ...
      function i(e, n) {
        if (r[e])
          return (
            console.error('Store "' + e + '" is already registered.'), r[e]
          );
        const o = n();
        if ("function" != typeof o.getSelectors)
          throw new TypeError("store.getSelectors must be a function");
        if ("function" != typeof o.getActions)
          throw new TypeError("store.getActions must be a function");
        if ("function" != typeof o.subscribe)
        ...
        if (
          ...
          try {
            U(o.store).registerPrivateActions(U(t).privateActionsOf(e)),
              U(o.store).registerPrivateSelectors(U(t).privateSelectorsOf(e));
          } catch (e) {}
        return o;
      }
      let u = {
    ...
    let Ne;
    try {
      (Ne = window.localStorage),
        Ne.setItem("__wpDataTestLocalStorage", ""),
        Ne.removeItem("__wpDataTestLocalStorage");
    } catch (e) {
      Ne = je;
    }
    const Ae = Ne,
    ...
    function Le(e, t) {
      const r = (function (e) {
        const { storage: t = Ae, storageKey: r = Pe } = e;
        let n;
        return {
          get: function () {
            if (void 0 === n) {
      ...
      return {
        registerStore(t, n) {
          ...
          if (void 0 !== o) {
            ...
            (e = Re(e) && Re(o) ? _e()(e, o, { isMergeableObject: Re }) : o),
              (n = { ...n, initialState: e });
          }
    ...
    var Ze = (e) =>
      (0, _.createHigherOrderComponent)(
        (t) =>
          (0, _.pure)((r) => {
            const n = Qe((t, n) => e(t, r, n));
            return (0, Me.createElement)(t, { ...r, ...n });
          }),
        "withSelect"
      );
    var et = (e, t) => {
          ...
          return Object.fromEntries(
            Object.entries(e).map(
              ([e, t]) => (
                "function" != typeof t &&
                  console.warn(
                    `Property ${e} returned from dispatchMap in useDispatchWithMap must be a function.`
                  ),
                [e, (...t) => n.current(r.dispatch, r)[e](...t)]
              )
            )
          );
        }, [r, ...t])
    ...
    var rt = (0, _.createHigherOrderComponent)(
      (e) => (t) =>
        (0, Me.createElement)(Ge, null, (r) =>
          (0, Me.createElement)(e, { ...t, registry: r })
        ),
      "withRegistry"
    );
    var nt = (e) => {
